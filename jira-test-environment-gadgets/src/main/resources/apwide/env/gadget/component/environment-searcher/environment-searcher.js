define('apwide/gadget/environmentSearcher', [], function () {
  ...
  return {init: addEnvironmentsSearch}
})

AJS.namespace('APWIDE.EnvironmentSearcher', null, require('apwide/gadget/environmentSearcher'))
